...
const talentServices = [
  { title: "IT Staff Augmentation", desc: "Embed senior software engineers directly into your team through our staff augmentation services. They ship code on day one.", icon: "M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z", href: "/services/talent/staff-augmentation" },
  { title: "CTO & VP Engineering Recruitment", desc: "CTO recruitment, VP of Engineering search, and Tech Lead placement. We find the technical executives who transform engineering organizations.", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z", href: "/services/talent/executive-recruitment" },
  { title: "Contract Software Engineers", desc: "Hire contract software engineers for defined engagements. Flexible IT staffing without compromising quality or delivery speed.", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", href: "/services/talent/contract-engineers" },
  { title: "Scale Your Engineering Team", desc: "Going from 5 to 50 developers? Our software engineer staffing team architects the hiring plan and executes it - fast.", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6", href: "/services/talent/team-scaling" },
  { title: "Technical Recruiting Advisory", desc: "Compensation benchmarks, engineering org design, and developer retention strategies. Technical recruiting advisory that goes beyond the hire.", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z", href: "/services/talent/recruiting-advisory" },
];

const labsServices = [
  { title: "Custom Software Development", desc: "Full-stack custom software development from API to interface. We build the entire product, not just features.", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4", href: "/services/labs/custom-software" },
  { title: "Product Design & UX", desc: "UX research, wireframes, prototypes, and pixel-perfect UI for web and mobile applications. Design that converts users into customers.", icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z", href: "/services/labs/product-design" },
  { title: "Cloud Infrastructure & DevOps", desc: "AWS, GCP, Azure - infrastructure as code, CI/CD pipelines, and monitoring. Enterprise-grade cloud architecture that scales with your product.", icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z", href: "/services/labs/cloud-devops" },
  { title: "AI & Data Engineering Services", desc: "ML pipelines, LLM integrations, and data platform engineering. AI-powered software development baked into your product from the ground up.", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", href: "/services/labs/ai-data" },
  { title: "Software Architecture Consulting", desc: "Architecture reviews, tech debt audits, and cloud migration strategies for enterprise software. We diagnose before we prescribe.", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", href: "/services/labs/architecture-consulting" },
];
